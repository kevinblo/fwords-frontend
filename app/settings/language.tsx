...
export default function LanguageScreen() {
  const { interfaceLanguageId, interfaceLanguageCode, languages, setInterfaceLanguage, isLoading: contextLoading } = useLanguage();
  ...
  const handleLanguageSelect = async (languageId: number) => {
    ...
    try {
      ...
      await setInterfaceLanguage(languageId);
      router.back();
    } catch (error) {
        ...
        {languages.map((language) => (
          <TouchableOpacity
            ...
            style={[
              ...
              interfaceLanguageId === language.id && styles.selectedItem,
              isDark && interfaceLanguageId === language.id && styles.selectedItemDark,
            ]}
          ...
          >
            <Text style={[
              ...
              interfaceLanguageId === language.id && styles.selectedText,
            ]}>
              {language.name_english}
            </Text>
            {interfaceLanguageId === language.id && !isUpdating && (
